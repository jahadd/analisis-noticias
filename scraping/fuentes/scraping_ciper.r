...
#enlaces ----
n_pags <- n_paginas_fuente("ciper", con)
enlaces <- c(
  paste0("https://www.ciperchile.cl/category/actualidad/page/", seq_len(n_pags)),
  paste0("https://www.ciperchile.cl/category/investigacion/page/", seq_len(n_pags))
)
