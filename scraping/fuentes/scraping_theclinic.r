...
n_pags <- n_paginas_fuente("theclinic", con)
enlaces <- c("https://www.theclinic.cl/noticias/politica/",
             paste0("https://www.theclinic.cl/noticias/politica/page/", seq(2L, n_pags + 1L)),
             "https://www.theclinic.cl/noticias/reportajes/",
             paste0("https://www.theclinic.cl/noticias/reportajes/page/", seq(2L, n_pags + 1L)),
             "https://www.theclinic.cl/lo-ultimo/",
             paste0("https://www.theclinic.cl/lo-ultimo/page/", seq(2L, n_pags + 1L))
)
