...
# Helper: GET ignorando errores SSL (reemplaza RCurl::getURL con cainfo)
.coop_html <- function(url) {
...
## enlaces noticias ----
noticias_html <- .coop_html(enlace_noticias)
...
## enlaces opinión ----
opinion_html <- .coop_html(enlace_opinion)
